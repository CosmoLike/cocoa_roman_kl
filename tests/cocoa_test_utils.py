"""Shared harness for the roman_kl unit tests.

The tests answer two questions about the roman_kl likelihoods:
...
covariance dimensions, and the cosmolike C layer ABORTS THE WHOLE
PROCESS when a second configuration with different dimensions
initializes after the first ("IP::set_mask: inconsistent mask"). Every
model build here therefore runs in its own worker subprocess: the
public single_model_chi2 and ten_in_a_row_chi2 spawn a fresh python
that imports this module, evaluates, and hands the numbers back
through a temporary json file, while its progress lines stream to the
same terminal. One pytest run can then cover every configuration.
...
def _ten_in_a_row_impl(example, tatt):
    ...
    for i, perturbation in enumerate(RACE_PERTURBATIONS, start=1):
        ...
        # The comprehension builds a new dictionary from the (name,
        # value) pairs whose name the point carries
        applied = {k: v for k, v in perturbation.items() if k in point}
        # {**point, **applied} is a NEW dictionary: point's entries
        # with the applied ones written over them; point itself stays
        # untouched for the final fiducial evaluation
...
# boxes of the five TATT parameters (ROMAN_KL_A1_1, ROMAN_KL_A1_2,
# ROMAN_KL_A2_1, ROMAN_KL_A2_2 in [-5, 5]; ROMAN_KL_BTA_1 in [0, 2]) with
...
FASTPT_COMPARISON_POINTS = [
    {"ROMAN_KL_A1_1": -2.347878, "ROMAN_KL_A1_2": -2.631529,
     "ROMAN_KL_A2_1": -4.548776, "ROMAN_KL_A2_2": 4.089803,
     "ROMAN_KL_BTA_1": 1.299591},
    {"ROMAN_KL_A1_1": -4.5757, "ROMAN_KL_A1_2": 1.842436,
     "ROMAN_KL_A2_1": -2.778512, "ROMAN_KL_A2_2": 2.349448,
     "ROMAN_KL_BTA_1": 1.771619},
    {"ROMAN_KL_A1_1": -1.885483, "ROMAN_KL_A1_2": -4.988485,
     "ROMAN_KL_A2_1": -1.485879, "ROMAN_KL_A2_2": -4.495962,
     "ROMAN_KL_BTA_1": 0.884889},
    {"ROMAN_KL_A1_1": 4.467901, "ROMAN_KL_A1_2": -3.113044,
     "ROMAN_KL_A2_1": 0.788438, "ROMAN_KL_A2_2": 4.321531,
     "ROMAN_KL_BTA_1": 0.595105},
    {"ROMAN_KL_A1_1": 2.925418, "ROMAN_KL_A1_2": 2.106288,
     "ROMAN_KL_A2_1": 3.514003, "ROMAN_KL_A2_2": -4.307538,
     "ROMAN_KL_BTA_1": 0.106922},
    {"ROMAN_KL_A1_1": 0.737236, "ROMAN_KL_A1_2": -2.601612,
     "ROMAN_KL_A2_1": -3.525379, "ROMAN_KL_A2_2": -2.532121,
     "ROMAN_KL_BTA_1": 1.551288},
    {"ROMAN_KL_A1_1": -2.208689, "ROMAN_KL_A1_2": 1.166122,
     "ROMAN_KL_A2_1": -3.89846, "ROMAN_KL_A2_2": -3.625951,
     "ROMAN_KL_BTA_1": 1.458385},
    {"ROMAN_KL_A1_1": 3.577859, "ROMAN_KL_A1_2": -2.150368,
     "ROMAN_KL_A2_1": 3.68132, "ROMAN_KL_A2_2": -0.800727,
     "ROMAN_KL_BTA_1": 1.338299},
    {"ROMAN_KL_A1_1": -3.301099, "ROMAN_KL_A1_2": -1.899991,
     "ROMAN_KL_A2_1": 2.247241, "ROMAN_KL_A2_2": -2.085669,
     "ROMAN_KL_BTA_1": 1.21194},
    {"ROMAN_KL_A1_1": -1.957003, "ROMAN_KL_A1_2": 2.044701,
     "ROMAN_KL_A2_1": 1.357407, "ROMAN_KL_A2_2": 3.861245,
     "ROMAN_KL_BTA_1": 0.112379},
    {"ROMAN_KL_A1_1": 1.56864, "ROMAN_KL_A1_2": -1.191915,
     "ROMAN_KL_A2_1": 2.709754, "ROMAN_KL_A2_2": -3.689616,
     "ROMAN_KL_BTA_1": 0.581821},
    {"ROMAN_KL_A1_1": 0.092758, "ROMAN_KL_A1_2": 4.358014,
     "ROMAN_KL_A2_1": -0.665741, "ROMAN_KL_A2_2": -1.574787,
     "ROMAN_KL_BTA_1": 0.158704},
    {"ROMAN_KL_A1_1": 1.205006, "ROMAN_KL_A1_2": 1.544994,
     "ROMAN_KL_A2_1": -2.161392, "ROMAN_KL_A2_2": -0.047689,
     "ROMAN_KL_BTA_1": 1.065058},
    {"ROMAN_KL_A1_1": 2.623534, "ROMAN_KL_A1_2": -4.583449,
     "ROMAN_KL_A2_1": 4.401911, "ROMAN_KL_A2_2": 3.545763,
     "ROMAN_KL_BTA_1": 1.463577},
    {"ROMAN_KL_A1_1": -4.459096, "ROMAN_KL_A1_2": 3.114698,
     "ROMAN_KL_A2_1": -0.526033, "ROMAN_KL_A2_2": 2.268589,
     "ROMAN_KL_BTA_1": 1.739542},
    {"ROMAN_KL_A1_1": 0.206121, "ROMAN_KL_A1_2": -4.811619,
     "ROMAN_KL_A2_1": 4.734078, "ROMAN_KL_A2_2": -2.90544,
     "ROMAN_KL_BTA_1": 1.16909},
    {"ROMAN_KL_A1_1": 3.56276, "ROMAN_KL_A1_2": -0.662237,
     "ROMAN_KL_A2_1": -0.174979, "ROMAN_KL_A2_2": 4.150983,
     "ROMAN_KL_BTA_1": 1.275072},
    {"ROMAN_KL_A1_1": 3.593366, "ROMAN_KL_A1_2": -4.875329,
     "ROMAN_KL_A2_1": 2.680328, "ROMAN_KL_A2_2": -3.169156,
     "ROMAN_KL_BTA_1": 0.538465},
    {"ROMAN_KL_A1_1": 1.290369, "ROMAN_KL_A1_2": 0.975332,
     "ROMAN_KL_A2_1": -0.422358, "ROMAN_KL_A2_2": -2.637129,
     "ROMAN_KL_BTA_1": 0.641767},
    {"ROMAN_KL_A1_1": 1.835056, "ROMAN_KL_A1_2": -1.493955,
     "ROMAN_KL_A2_1": 1.138184, "ROMAN_KL_A2_2": 4.009877,
     "ROMAN_KL_BTA_1": 1.228736},
    {"ROMAN_KL_A1_1": 0.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 0.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 4.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 0.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": -4.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 0.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 0.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 4.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 0.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": -4.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 4.0, "ROMAN_KL_A1_2": 4.0,
     "ROMAN_KL_A2_1": 0.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 4.0, "ROMAN_KL_A1_2": -4.0,
     "ROMAN_KL_A2_1": 0.0, "ROMAN_KL_A2_2": 0.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 0.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 4.0, "ROMAN_KL_A2_2": 4.0,
     "ROMAN_KL_BTA_1": 0.0},
    {"ROMAN_KL_A1_1": 0.0, "ROMAN_KL_A1_2": 0.0,
     "ROMAN_KL_A2_1": 4.0, "ROMAN_KL_A2_2": -4.0,
     "ROMAN_KL_BTA_1": 0.0},
...
def _fastpt_comparison_info(example, fastpt, high, fastpt_settings):
    ...
    # this project FIXES the TATT second-order parameters
    # (value: 0.0) in its cosmic-shear configuration instead of
    # sampling them; the comparison varies all five IA parameters,
    # so any fixed comparison parameter is promoted to a sampled one
    # carrying its prior box, and the evaluation base gains it with
    # a zero default
    for name in FASTPT_COMPARISON_POINTS[0]:
...
def _fastpt_comparison_block(example, fastpt, high, fastpt_settings=None,
    ...
    model = make_model(info)
    # the frozen point does not carry the promoted parameters (they
    # are fixed in the shipped configuration), so the evaluation base
    # is assembled here: the frozen point plus a zero for each
    # promoted name, checked against the model's sampled set the same
    # way build_point checks the unpromoted configurations
    base = dict(load_frozen_point(example))
    for name in FASTPT_COMPARISON_POINTS[0]:
        if name not in base:
            base[name] = 0.0
    sampled = set(model.parameterization.sampled_params())
    if sampled != set(base):
        raise AssertionError(
            "sampled-parameter set differs from the frozen point plus "
            "the promoted IA parameters: model only "
